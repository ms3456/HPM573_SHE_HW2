...
def get_score(vision, hearing, speech, ambulation, dexterity, emotion, cognition, pain):
    ...
    # check entered values for validity
    ...
    score = N6*dictCoefficients['Vision'][vision-1]*dictCoefficients['Hearing'][hearing-1]*\
            dictCoefficients['Speech'][speech-1]*dictCoefficients['Ambulation'][ambulation-1]*\
            dictCoefficients['Dexterity'][dexterity-1]*dictCoefficients['Emotion'][emotion-1]*\
            dictCoefficients['Cognition'][cognition-1]*dictCoefficients['Pain'][pain-1] - Constant
